...
# Pose Estimation을 사용한 신체 KeyPoint 추론하는 모델 정의 Class
...
# Fast Pose를 사용한 KeyPoints 출력
class InferenNet_fast(nn.Module):

    # Fast Pose 경로 (Weight Load)
    def __init__(self, weights_file='C:/Users/Lee/Desktop/project/FallDown_Detection/Models/sppe/fast_res101_320x256.pth'):
