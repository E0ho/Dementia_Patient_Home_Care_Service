# 추출한 KeyPoint 정보를 활용한 행동 인식 모델 학습 데이터 생성
...
# Train 파일
csv_pose_file = 'C:/Users/Lee/Desktop/project/FallDown_Detection/Data/Skeleton_KeyPoints_train.csv'
save_path = 'C:/Users/Lee/Desktop/project/FallDown_Detection/Data/train.pkl'

# # Validation 파일
# csv_pose_file = 'C:/Users/Lee/Desktop/project/FallDown_Detection/Data/Skeleton_KeyPoints_valid.csv'
# save_path = 'C:/Users/Lee/Desktop/project/FallDown_Detection/Data/valid.pkl'

# # Test 파일
# csv_pose_file = 'C:/Users/Lee/Desktop/project/FallDown_Detection/Data/Skeleton_KeyPoints_test.csv'
# save_path = 'C:/Users/Lee/Desktop/project/FallDown_Detection/Data/test.pkl'
...
def plot_total_label(labels_set,cols):
    ...
    # Action(class) Label index : ['Standing', 'Sitting', 'Lying Down','Stand up', 'Sit down', 'Fall Down']
    label_idx=[]  # tìm
    cols=list(cols)
    ...
    # 각 Class의 총 Frame수 계산
    values=np.zeros((len(class_names),),dtype=int)
    for i in range(len(values)):
        values[i]=sum(label==label_idx[i])

    # 각 Class 빈도 확인
    names = ['Standing', 'Sitting', 'Lying Down','Stand up', 'Sit down', 'Fall Down']
...
for vid in vid_list:
    ...
    for fs in frames_set:
        ...
        for i in range(xys.shape[0] - n_frames):
            feature_set = np.append(feature_set, xys[i:i+n_frames][None, ...], axis=0) # FPS = 30
