...
class TSSTG(object):
    ...
    def __init__(self,
                weight_file='C:/Users/Lee/Desktop/project/FallDown_Detection/Actionsrecognition/saved/TSSTG(pts+mot)-01(cf+hm-hm)/tsstg-model.pth', # 행동 인지 모델 가중치 부여
                device='cuda'):
        self.graph_args = {'strategy': 'spatial'}

        # self.class_names = ['Standing', 'Standing','Sitting', 'Lying Down','Stand up', 'Sit down', 'Fall Down']
        self.class_names = ['Standing', 'Sitting', 'Lying Down','Stand up', 'Sit down', 'Fall Down']
